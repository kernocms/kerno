	...
	<div class="full">
		...
		<div class="pad20_f">
			...
			<div class="input">
				...
				<img src="{home}/captcha.php" class="left" onclick="reload_captcha();" id="img_captcha" style="cursor: pointer;" alt="Security code"/>
...
<script type="text/javascript">
	function reload_captcha() {
		...
		if (captc != null) {
			captc.src = "{home}/captcha.php?rand=" + Math.random();
		}
	}
</script>